...
> **Статус с 15.09.2026: LEGACY v1 / СОХРАНЁН ДЛЯ ИСТОРИИ.**
> Эта матрица сохраняет полную трассировку программного прототипа A2/A3. Активная трассировка no-code ВКР находится в `TRACEABILITY_THEORETICAL_V2.md` и `ROADMAP_THEORETICAL_V2.md`. Старые строки не удаляются.

Статус исторической версии: **PRESERVED / LEGACY**.

Трассировка программного прототипа строилась по цепочке:
...
## Правило статуса legacy

Эта матрица больше не определяет готовность ВКР. Она хранит доказательства уже выполненного программного прототипирования. Текущая готовность оценивается документарными Gate T0–T7 из theoretical roadmap v2.
