# Методика ЕГ — T4: трассировка проектных решений
...
| D18 | **«Методика ЕГ»** выбрана вместо A0–A2 | P1/P2/P3/P6/P7/P8 | совокупная база T1/T2 | alternatives |
...
- **3.1** — альтернативы, выбор **«Методики ЕГ»**, TO-BE;
